        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-10">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{old('name') }}" placeholder="Entrer votre nom"
                ...
                <div>
                    ...
                    <input type="email" name="email" required value="{{old('email') }}" placeholder="[email protected]"
                        class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                </div>
                ...
                <p class="text-center text-gray-600">
                    ...
                    <a href="{{ route('show.login') }}" class="text-blue-600 font-semibold hover:underline">
                        Se connecter
                    </a>
                </p>
