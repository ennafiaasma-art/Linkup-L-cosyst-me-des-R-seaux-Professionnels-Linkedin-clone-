            ...
            <div class="space-y-4">
                ...
                @forelse($posts as $post)
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="px-4">
                            <div
                                class="flex items-center justify-between text-xs text-gray-500 pb-1.5 border-b border-gray-100">
                                <span class="flex items-center gap-1">
                                    <span
                                        class="w-4 h-4 rounded-full bg-blue-600 text-white flex items-center justify-center text-[10px]">👍</span>
                                    {{ $post->likes()->count() }}
                                </span>
                                <span>{{ $post->comments->count() }}
                                    commentaire{{ $post->comments->count() > 1 ? 's' : '' }}</span>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center py-1">
                                    ...
                                    <button
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5"
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M7 11v10H4a1 1 0 01-1-1v-8a1 1 0 011-1h3zm0 0l4.5-8a2 2 0 013.5 1.5V9h4.2a2 2 0 011.98 2.28l-1.14 8A2 2 0 0117.58 21H7" />
                                        </svg>
                                        J'aime
                                    </button>
                                </form>
                                ...
                                <button type="button" onclick="toggleComments({{ $post->id }})"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5" fill="none"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8-1.06 0-2.078-.163-3.024-.463L3 21l1.539-4.615C3.564 15.088 3 13.598 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                    </svg>
                                    Commenter
                                </button>
                            </div>
